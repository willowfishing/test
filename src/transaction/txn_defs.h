   ...
   public:
    ...
    std::string GetInfo() {
        switch (abort_reason_) {
            ...
            case AbortReason::WRITE_WRITE_CONFLICT: {
                return "Transaction " + std::to_string(txn_id_) + " aborted for write-write conflict\n";
            } break;
            case AbortReason::SERIALIZATION_FAILURE: {
                return "Transaction " + std::to_string(txn_id_) + " aborted for serialization failure\n";
            } break;
