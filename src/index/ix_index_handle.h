...
class IxIndexHandle {
   ...
   public:
    ...
    // Internal pages use n separator keys and n+1 child pointers. Insert a
    // separator after child[child_idx], i.e. key[child_idx] and child[child_idx+1].
    void insert_internal_after_child(IxNodeHandle *parent, int child_idx, const char *key, const Rid &new_child);
