...
#line 2646 "yacc.tab.cpp"
    break;

  case 118: /* optGroupClause: %empty  */
#line 656 "yacc.y"
                      { (yyval.sv_cols) = {}; }
#line 2652 "yacc.tab.cpp"
    break;
