   ...
   public:
    ...
    std::unique_ptr<RmRecord> Next() override {
        ...
        for (auto &index : tab_.indexes) {
            ...
            if (ih->get_value(key.data(), &found, context_->txn_)) {
        ...
        MvccManager::CheckWrite(context_->txn_, tab_name_, rid_, tab_.cols, std::vector<const RmRecord *>{&rec});
        MvccManager::AppendVersion(tab_name_, rid_, context_->txn_, false, rec);
        return nullptr;
    }
